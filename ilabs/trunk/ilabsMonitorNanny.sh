...
if [[ -z $pid ]]; then
    ...
    cd $dir
    nohup ilabsMonitor.py -r mcahn@princeton.edu -r glaevsky@princeton.edu -r augustin@princeton.edu -r cdecoste@princeton.edu -r kr7@princeton.edu > $monitor_stdout 2>&1 &
