...
monitor_stdout=/var/log/ilab/ilabMonitor-stdout.log
nanny_logfile=/var/log/ilab/ilabMonitorNanny.log
...
if [[ -z $pid ]]; then
    ...
    cd $dir
    nohup ilabMonitor.py --config ilab-config-test.yaml --verbose > $monitor_stdout 2>&1 &
